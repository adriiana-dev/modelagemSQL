...
-- Categorias
INSERT INTO categorias (id, nome) VALUES (1, 'Smash Burgers'), (2, 'Hambúrgueres Artesanais'), (3, 'Porções e Entradas'), 
(4, 'Bebidas Naturais e Refri'), (5, 'Sobremesas e Shakes');

-- Metodos_pagamento
INSERT INTO metodos_pagamento (id, forma_transacao) VALUES 
...
-- Clientes
INSERT INTO clientes (id, cpf, nome, telefone, endereco, data_cadastro) VALUES 
...
-- Entregadores
INSERT INTO entregadores (id, nome, telefone, placa_veiculo) VALUES 
(1, 'Tiago Silva', '11977771111', 'RTL-8A99'), (2, 'Roberto Santos', '11977772222', 'QKW-2B34'),
(3, 'Fernando Costa', '11977773333', 'PLM-9C12');

-- Fornecedores
INSERT INTO fornecedores (id, cnpj, nome_fantasia, telefone, email) VALUES 
...
--Ingredientes
INSERT INTO ingredientes (id, nome, unidade_medida, estoque_atual) VALUES 
...
--Mesas
INSERT INTO mesas (id, capacidade, status) VALUES 
(1, 2, 'Livre'), (2, 4, 'Ocupada'), (3, 4, 'Livre'), (4, 6, 'Reservada'), (5, 2, 'Livre');

-- Promocoes
INSERT INTO promocoes (id, nome, desconto, data_inicio, data_fim) VALUES 
...
-- Produtos
INSERT INTO produtos (id, nome, valor_unitario, estoque, id_categoria) VALUES 
...
-- Pedidos
INSERT INTO pedidos (id, data, hora_pedido, status, id_funcionario, id_cliente, id_mesa) VALUES
(1, '2026-03-08', '11:10', 'Finalizado', 3, 1, 1), (2, '2026-03-08', '12:25', 'Finalizado', 1, 2, 2),
(3, '2026-03-08', '13:40', 'Finalizado', 3, 3, NULL), (4, '2026-03-09', '11:35', 'Finalizado', 1, 4, 3),
(5, '2026-03-09', '12:50', 'Finalizado', 3, 5, NULL), (6, '2026-03-09', '19:05', 'Finalizado', 1, 6, 4),
(7, '2026-03-09', '20:15', 'Cancelado', 3, 7, 1), (8, '2026-03-10', '11:20', 'Finalizado', 1, 8, NULL),
(9, '2026-03-10', '12:10', 'Finalizado', 3, 9, 2), (10, '2026-03-10', '13:30', 'Finalizado', 1, 10, NULL),
(11, '2026-03-10', '18:45', 'Finalizado', 3, 11, 3), (12, '2026-03-10', '20:00', 'Finalizado', 1, 12, 4),
(13, '2026-03-11', '10:50', 'Finalizado', 3, 13, NULL), (14, '2026-03-11', '11:15', 'Finalizado', 1, 14, 1),
(15, '2026-03-11', '12:05', 'Finalizado', 3, 15, 2), (16, '2026-03-11', '12:55', 'Finalizado', 1, 16, NULL),
(17, '2026-03-11', '13:20', 'Finalizado', 3, 17, 3), (18, '2026-03-11', '18:10', 'Finalizado', 1, 18, NULL),
(19, '2026-03-11', '18:35', 'Finalizado', 3, 19, 4), (20, '2026-03-11', '19:00', 'Finalizado', 1, 20, 1),
(21, '2026-03-11', '20:15', 'Finalizado', 3, 21, NULL), (22, '2026-03-11', '20:35', 'Em Rota', 1, 22, NULL),
(23, '2026-03-11', '20:50', 'Em Preparo', 3, 23, 3), (24, '2026-03-11', '21:05', 'Aguardando', 1, 24, NULL),
(25, '2026-03-11', '21:20', 'Em Preparo', 3, 25, 4), (26, '2026-03-11', '21:35', 'Em Preparo', 1, 26, 1),
(27, '2026-03-11', '21:50', 'Novo', 3, 27, NULL), (28, '2026-03-11', '22:05', 'Aguardando', 1, 28, 2),
(29, '2026-03-11', '22:20', 'Novo', 3, 29, 3), (30, '2026-03-11', '22:35', 'Novo', 1, 30, NULL);
...
-- Receitas
INSERT INTO receitas (id, id_produto, id_ingrediente, quantidade_necessaria, preparo) VALUES 
(1, 3, 1, 1.00, 'Tostar pão'), (2, 3, 2, 2.00, 'Fazer smash'), (3, 3, 3, 2.00, 'Derreter cheddar');

--itens_compra
INSERT INTO itens_compra (id, id_compra, id_ingrediente, quantidade, valor_unitario, valor_total) VALUES 
(1, 1, 2, 100.00, 25.00, 2500.00), (2, 2, 4, 100.00, 4.50, 450.00), (3, 3, 8, 66.67, 18.00, 1200.00);

-- Item_produto
INSERT INTO item_produto (id, id_pedido, id_produto, quantidade, valor_unitario, valor_total) VALUES 
(1,1,1,1,22.90, 22.90), (2,2,3,2,32.90, 65.80), (3,3,26,1,38.90, 38.90), (4,4,10,1,35.90, 35.90), (5,5,11,2,6.50, 13.00), (6,6,22,1,34.90, 34.90), 
(7,7,5,1,36.90, 36.90), (8,8,28,1,89.90, 89.90), (9,9,17,1,22.00, 22.00), (10,10,8,2,37.90, 75.80), (11,11,23,1,29.90, 29.90), (12,12,7,1,38.00, 38.00), 
(13,13,27,1,52.90, 52.90), (14,14,14,3,4.50, 13.50), (15,15,10,1,35.90, 35.90), (16,16,4,1,39.90, 39.90), (17,17,20,2,24.90, 49.80), (18,18,2,3,24.90, 74.70), 
(19,19,12,1,6.50, 6.50), (20,20,24,1,24.00, 24.00), (21,21,26,2,38.90, 77.80), (22,22,6,1,29.90, 29.90), (23,23,19,1,14.00, 14.00), (24,24,29,1,29.90, 29.90), 
(25,25,16,4,13.00, 52.00), (26,26,2,1,24.90, 24.90), (27,27,4,2,39.90, 79.80), (28,28,21,1,22.90, 22.90), (29,29,25,1,26.90, 26.90), (30,30,30,3,3.50, 10.50),
(31, 31, 1, 1, 22.90, 22.90), (32, 32, 1, 1, 22.90, 22.90);
...
(4, 4, 4, 35.90, '2026-03-09'), (5, 5, 1, 13.00, '2026-03-09'), (6, 6, 3, 34.90, '2026-03-09'),
(7, 8, 2, 89.90, '2026-03-10'), (8, 9, 4, 22.00, '2026-03-10'), (9, 10, 1, 75.80, '2026-03-10'),
(10, 11, 3, 29.90, '2026-03-10'), (11, 12, 2, 38.00, '2026-03-10'),
(12, 13, 1, 52.90, '2026-03-11'), (13, 14, 4, 13.50, '2026-03-11'), (14, 15, 2, 35.90, '2026-03-11'),
(15, 16, 1, 39.90, '2026-03-11'), (16, 17, 3, 49.80, '2026-03-11'), (17, 18, 4, 74.70, '2026-03-11'),
(18, 19, 1, 6.50, '2026-03-11'), (19, 20, 2, 24.00, '2026-03-11'), (20, 21, 4, 77.80, '2026-03-11');
...
-- Avaliações
INSERT INTO avaliacoes (id, id_cliente, id_pedido, nota, comentario) VALUES 
